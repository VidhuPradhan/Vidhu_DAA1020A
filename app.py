...
botsettings = BotFrameworkAdapterSettings("09ccdff8-9b92-4667-bb30-c0a634b29305","adcc81ba-c705-4052-b36e-f2e86487fab7")
...
if __name__ == '__main__':
    app.run('https://bot1020avidhu.azurewebsites.net/api/messages',3978)
